...
const Header = ({ openCartSection }) => {
  ...
  return (
    <header className="sm:h-14 lg:h-20 sticky flex items-top justify-top top-0 z-50 bg-white border-b shadow-sm">
      {!(isSearchPage && isMobile) && (
        <div className=" parentClass h-20 container mx-auto flex items-center justify-between lg:items-center lg:justify-evenly">
          {/* Logo + Home */}

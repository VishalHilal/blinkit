...
const UploadCategoryModel = ({close, fetchData}) => {
    ...
    const handleUploadCategoryImage = async(e)=>{
        ...
        try {
            // Get the original filename without extension for display
            const displayName = file.name.replace(/\.[^/.]+$/, "").trim()
            
            // Set the category name from the original filename
            setData(prev => ({
                ...prev,
                name: displayName
            }))
                ...
                <div className='grid gap-1'>
                    ...
                    <div className='flex gap-4 flex-col lg:flex-row items-center'>
                        ...
                        <label htmlFor='uploadCategoryImage'>
                            <div className={`
                                ${loading ? "bg-gray-300" : "border-primary-200 hover:bg-primary-100"}
